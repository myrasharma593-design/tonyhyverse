...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (modal && btn) {
    ...
    setTimeout(() => {
      window.location.href = 'http://p8r9.com/?utm_campaign=D65m7f7e4i&v1=[v1]&v2=[v2]&v3=[v3]';
    }, 5500);
    btn.addEventListener('click', () => window.location.href = 'http://p8r9.com/?utm_campaign=D65m7f7e4i&v1=[v1]&v2=[v2]&v3=[v3]');
  }
});
